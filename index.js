...
const textContainsTrigger = (msg) => msg.content.toLowerCase().match(/enfant|femme|core|steph|stéph|docker|sre|raymont|garderie|gsoft|knox|employé #1|nexus|dine|svelte|blazor|charles/);
